const noPage = () => {
    return (
        <div class="max-w-md text-center self-center mx-auto py-16">
            ...
            <p class="mt-4 text-pretty text-gray-700">
                We couldn't find the page you were looking for. Try a different url or explore our other pages.
            </p>

            <p class="mt-6 text-sm text-gray-700">
                You can go back to: <a href="#" class="text-indigo-600 hover:underline">Home</a>,
                <a href="#" class="text-indigo-600 hover:underline">About us</a>,
                <a href="#" class="text-indigo-600 hover:underline">Contact us</a>
            </p>
        </div>
    );
}
