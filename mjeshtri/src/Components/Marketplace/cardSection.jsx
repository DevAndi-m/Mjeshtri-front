...
const CardSection = ({ filters }) => {
    ...
    if (loading) return (
        <svg class="mx-auto size-8 animate-spin text-blue-600 m-10" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 p-4 lg:mx-10 xl:mx-32 mb-10">
            {experts.length > 0 ? (
                ...
                <div className="col-span-full text-center py-10 text-gray-500">
                    No experts found with the given fitlers.
                </div>
            )}
        </div>
    );
