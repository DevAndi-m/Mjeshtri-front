    ...
    return (
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            <div>
                ...
                <input className="p-2 mt-1 w-full rounded-lg border border-gray-300 bg-white focus:border-blue-500 focus:outline-none" id="name" type="text" placeholder="Your name" />
            </div>

            <div>
                <label className="block text-sm font-medium text-gray-900" for="email">Email</label>

                <input className="p-2 mt-1 w-full rounded-lg border border-gray-300 bg-white focus:border-blue-500 focus:outline-none" id="email" type="email" placeholder="Your email" />
            </div>

            <div>
                <label className="block text-sm font-medium text-gray-900" for="message">Message</label>

                <textarea className="p-2 mt-1 w-full resize-none rounded-lg border border-gray-300 bg-white focus:border-blue-500 focus:outline-none" id="message" rows="4" placeholder="Your message"></textarea>
            </div>

            <button className="block w-full rounded-lg border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition-colors hover:bg-transparent hover:text-blue-600 cursor-pointer" type="submit">
                Send Message
            </button>
            </form>
        </div>
